if [ $# -lt 7 ]
then
        echo "Usage: $0 <dimension> <n2v.window> <n2v.p> <n2v.q> <mode (nodes/text/both)> <num_quanta (e.g. 20; set to 0 for no quantization) <larger context (true/false)>>"
        exit
fi
...
python pairwise-ov.py -d $DATA_DIR/sentences/train.tsv -n ../../../../core/$NODEFILE
