...
PROPFILE=$SCRIPTDIR/com.ibm.drl.hbcp.inforetrieval.apr.properties
...
com.ibm.drl.hbcp.inforetrieval.apr.qrels=com.ibm.drl.hbcp.inforetrieval.apr/qrels/qrels.txt
...
mvn compile
mvn exec:java@apindex -Dexec.args=$PROPFILE
