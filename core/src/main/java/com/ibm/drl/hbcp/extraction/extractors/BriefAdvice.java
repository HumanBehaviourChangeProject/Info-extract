...
/**
 * Extract value for 'Brief advice' matching "brief advice" or "brief physician advice".  This is under "Labelled interventions".
 * 
 * @author charlesj
 *
 */
public class BriefAdvice extends RegexQueryExtractor<ArmifiedAttributeValuePair>
    implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Brief advice";
    public final static String QUERY_STRING = "(brief OR physician) AND advice";
    private final static List<Pattern> REGEXES = Lists.newArrayList(
            Pattern.compile("(brief( physician)? advice)", Pattern.CASE_INSENSITIVE)
    );
    private final Attribute attribute;
    private final Set<Attribute> relevantAttributeSet;

    public BriefAdvice(int numberOfTopPassages) throws ParseException {
        this(IndexingMethod.NONE, numberOfTopPassages);
    }

    public BriefAdvice(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        BriefAdvice extractor = new BriefAdvice(5);
