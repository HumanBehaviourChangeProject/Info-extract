    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {        	
            	...
            	prop.load(GraphCoarsener.class.getClassLoader().getResourceAsStream("init.properties"));
            }
            ...
            gb.saveGraph(gc.modifiedGraph, "coarsened", RelationGraphBuilder.GraphType.DEFAULT);
        }
        catch (Exception ex) {
            ex.printStackTrace();
        }
