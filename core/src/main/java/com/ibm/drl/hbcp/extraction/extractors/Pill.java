...
/**
 * Extract mode of delivery related to pills
 *
 * @author charlesj
 *
 */
public class Pill extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Pill";
    private static final List<String> QUERY_WORDS = Lists.newArrayList(
        "bupropion",
                "varenicline",
                "tablets",
                "pills",
                "nortriptyline hydrochloride",  // TODO won't match this I guess
                "hydrochloride",
                "placebo"
    );
    ...
    public Pill(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        Pill hp = new Pill(IndexingMethod.slidingWindow(50, props),5);
