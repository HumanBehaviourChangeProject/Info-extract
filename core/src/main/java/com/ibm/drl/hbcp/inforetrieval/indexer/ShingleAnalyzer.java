...
*/public class ShingleAnalyzer extends Analyzer {
    ...
    protected Analyzer.TokenStreamComponents createComponents(String string) {
    	...
    	try (Tokenizer source = new StandardTokenizer();) {
			...
			// PT change, source stream was kept hanging otherwise    		
    		throw new IllegalStateException("Impossible to close the token stream.", ioe);
    	}
