...
/**
 * Extract mentions of tobacco companies
 *
 * @author charlesj
 *
 */
public class TobaccoCompanyFunding extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Tobacco company funding";
    ...
    public TobaccoCompanyFunding(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        TobaccoCompanyFunding hp = new TobaccoCompanyFunding(IndexingMethod.slidingWindow(50, props),50);
