...
/**
 * Extract value for 'Physical activity' matching "physical activity" or "exercise".  This is under "Labelled interventions".
 * 
 * @author charlesj
 *
 */
public class PhysicalActivity extends RegexQueryExtractor<ArmifiedAttributeValuePair>
    implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Physical activity";
    public final static String QUERY_STRING = "\"physical activity\" exercise";
    private final static List<Pattern> REGEXES = Lists.newArrayList(
            Pattern.compile("(physical activity|exercise)", Pattern.CASE_INSENSITIVE)
    );
    private final Attribute attribute;
    private final Set<Attribute> relevantAttributeSet;

    public PhysicalActivity(int numberOfTopPassages) throws ParseException {
        this(IndexingMethod.NONE, numberOfTopPassages);
    }

    public PhysicalActivity(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        PhysicalActivity extractor = new PhysicalActivity(3);
