...
/**
 * Extract mentions of mindfulness
 *
 * @author charlesj
 *
 */
public class Mindfulness extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Mindfulness";
    ...
    public Mindfulness(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
        super(indexingMethod, numberOfTopPassages, QUERY_WORDS, true);  // mindfulness gets stemmed to mind
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        Mindfulness hp = new Mindfulness(IndexingMethod.slidingWindow(50, props),50);
