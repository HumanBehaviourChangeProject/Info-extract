...
public class ExtractedInfoRetriever implements Closeable {
    ...
    */    
    public TopDocs retrieve(String attribId) throws Exception {
        Query q = new TermQuery(new Term(ExtractionIndexation.ExtractionIndexedFields.ATTRIB_ID_FIELD, attribId));
    ...
    */    
    ...
    String formatIURecordHTML(int docId) throws Exception {
        ...
        buff.append("<td>");
        buff.append(d.get(ExtractionIndexation.ExtractionIndexedFields.ATTRIB_ID_FIELD));
        buff.append("</td>");
        
        buff.append("<td>");
        buff.append(d.get(ExtractionIndexation.ExtractionIndexedFields.ATTRIB_NAME_FIELD));
        buff.append("</td>");
        
        buff.append("<td>");
        String docName = d.get(ExtractionIndexation.ExtractionIndexedFields.DOCNAME_FIELD);
        buff.append(docName);
        buff.append("</td>");
        
        buff.append("<td>");
        buff.append(d.get(ExtractionIndexation.ExtractionIndexedFields.EXTRACTED_VALUE_FIELD));
        buff.append("</td>");
    ...
    public List<String> exportRecordsAsJSONArray() throws Exception {
        ...
        for (int i=0; i < n; i++) {
            ...
            String json = d.get(ExtractionIndexation.ExtractionIndexedFields.JSON_FIELD);
            jsons.add(json);
        }
        return jsons;
    }
    ...
    public List<IUnitPOJO> getIUnitPOJOs() throws IOException {
        ...
        for (int i=0; i < n; i++) {
            ...
            IUnitPOJO pojo = new IUnitPOJO(
                    d.get(ExtractionIndexation.ExtractionIndexedFields.ATTRIB_TYPE_FIELD),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.DOCNAME_FIELD),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.EXTRACTED_VALUE_FIELD),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.ATTRIB_NAME_FIELD),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.CONTEXT_FIELD),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.ARM_ID),
                    d.get(ExtractionIndexation.ExtractionIndexedFields.ARM_NAME)
            );
            iupojoList.add(pojo);
        }
        return iupojoList;
