...
public class Somatic extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final List<String> QUERY_WORDS = Lists.newArrayList(
            "nicotine replacement therapy", "gum", 
            "Nicotine patch", "inhaler", "nicotine gum",
            "nasal spray", "NRT",
            "lozenge", "gum", "cessation aids"
    );

    private final Attribute attribute;

    public Somatic(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
        super(indexingMethod, numberOfTopPassages, QUERY_WORDS, false);
        this.attribute = Attributes.get().getFromName("Somatic");
    }
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        Somatic faceToFace = new Somatic(IndexingMethod.slidingWindow(50, props),5);
