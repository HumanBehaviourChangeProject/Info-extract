...
/**
 * Extract mentions of tobacco companies (see also {@link TobaccoCompanyFunding})
 *
 * @author charlesj
 *
 */
public class TobaccoCompanyCompetingInterest extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Tobacco company competing interest";
    ...
    public TobaccoCompanyCompetingInterest(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        TobaccoCompanyCompetingInterest hp = new TobaccoCompanyCompetingInterest(IndexingMethod.slidingWindow(20, props),20);
