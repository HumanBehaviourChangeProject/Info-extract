...
/**
 * Extract mentions of there being no funding (e.g., 'no financial support', 'no funding')
 *
 * @author charlesj
 *
 */
public class NoFunding extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "No funding";
    ...
    public NoFunding(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        NoFunding hp = new NoFunding(IndexingMethod.slidingWindow(20, props),20);
