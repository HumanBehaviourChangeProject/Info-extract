...
public class ResearchDoc {
	...
	private static final Logger logger = LoggerFactory.getLogger(ResearchDoc.class);
    ...
    public void extractInfoFromDOM() throws TikaException, SAXException, IOException {
        ...
        */
        ...
        try {
        	...
        	logger.warn("Some metadata may be missing for '" + (file != null ? file.getAbsolutePath() : "[queried file]") + "'!");
        }
        plainText = ppText;
    }
