...
/**
 * Extract mentions of pharmaceutical companies
 *
 * @author charlesj
 *
 */
public class PharmaceuticalCompanyFunding extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Pharmaceutical company funding";
    ...
    public PharmaceuticalCompanyFunding(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        PharmaceuticalCompanyFunding hp = new PharmaceuticalCompanyFunding(IndexingMethod.slidingWindow(50, props),50);
