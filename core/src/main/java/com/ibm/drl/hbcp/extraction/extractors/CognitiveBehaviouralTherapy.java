...
/**
 * Extract mentions of Cognitive Behavioural Therapy
 *
 * @author charlesj
 *
 */
public class CognitiveBehaviouralTherapy extends RegexQueryExtractor<ArmifiedAttributeValuePair>
        implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Cognitive Behavioural Therapy";
    public final static String QUERY_STRING = "cognitive behavioural behavioral therapy cbt";
    private final static List<Pattern> REGEXES = Lists.newArrayList(
            Pattern.compile("(Cognitive Behaviou?r(al)?( Therapy)?)", Pattern.CASE_INSENSITIVE),
            Pattern.compile("(CBT)")
    );
    private final Attribute attribute;

    public CognitiveBehaviouralTherapy(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        CognitiveBehaviouralTherapy hp = new CognitiveBehaviouralTherapy(IndexingMethod.slidingWindow(50, props),50);
