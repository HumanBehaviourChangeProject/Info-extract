...
/**
 * Extract mentions of Motivational Interviewing
 *
 * @author charlesj
 *
 */
public class MotivationalInterviewing extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Motivational Interviewing";
    ...
    public MotivationalInterviewing(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        MotivationalInterviewing hp = new MotivationalInterviewing(IndexingMethod.slidingWindow(50, props),5);
