...
public class AbstractDetectPresenceAttributesFactory {
    ...
    */    
    public List<InformationUnit> createInformationUnits() {
        ...
        createInformationUnits(iuList, AttributeType.INTERVENTION, "extract.bct", "attributes.typedetect.ids");
        return iuList;
    }
     ...
     * @param type The attribute type for which to create the object.
    ...
    */    
    public void createInformationUnits(
        ...
        for (String attribId : attribIds) {
            iuList.add(new AbstractDetectPresenceAttribute(extractor, ResearchDoc.FIELD_CONTENT, type, attribId));
        }
    }
    ...
    public List<InformationUnit> createSupervisedInformationUnits() {
        ...
        for (int i=0; i < attribIds.length; i++) {
            iuList.add(new AbstractDetectPresenceAttribute(extractor,
                    ResearchDoc.FIELD_CONTENT, AttributeType.INTERVENTION, attribIds[i]));
        }
        return iuList;
    }
