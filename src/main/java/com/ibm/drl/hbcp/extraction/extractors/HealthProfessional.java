...
public class HealthProfessional extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final List<String> QUERY_WORDS = Lists.newArrayList(
        "physician", "physicians", "PN",
            "nurse", "nurses",
            "GP", "GPs", "general practitioner",
            "health educator", "health educators",
            "counsellors", "counsellor", "counselor", "counselors",
            "hygienist", "hygienists",
            "cardiologist", "cardiologists", "obstetrician", "physiologist",
            "doctor", "doctors",
            "health advisor", "health adviser",
    ...
    public HealthProfessional(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
        super(indexingMethod, numberOfTopPassages, QUERY_WORDS, false);
        this.attribute = Attributes.get().getFromName("Health Professional");
    }
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        HealthProfessional hp = new HealthProfessional(IndexingMethod.slidingWindow(50, props),5);
