 ...
 * @author charlesj
 * */
public class PredicateArmifiedEvaluator implements PredicateUnarmifiedEvaluator<IndexedDocument, ArmifiedAttributeValuePair>, ArmifiedEvaluator {

    private PredicateUnarmifiedEvaluator<IndexedDocument, ArmifiedAttributeValuePair> unArmifiedEval;

    public PredicateArmifiedEvaluator(PredicateUnarmifiedEvaluator<IndexedDocument, ArmifiedAttributeValuePair> unArmifiedEval) {
