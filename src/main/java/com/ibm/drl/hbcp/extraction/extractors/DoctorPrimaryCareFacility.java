...
/**
 * Extract mentions of Doctor-led primary care facilities, e.g., "general practice"
 *
 * @author charlesj
 *
 */
public class DoctorPrimaryCareFacility extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Doctor-led primary care facility";
    private static final List<String> QUERY_WORDS = Lists.newArrayList(
            "general practice",
            "general practices",
            "Internal medicine and family practice offices",
    ...
    public DoctorPrimaryCareFacility(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        DoctorPrimaryCareFacility hp = new DoctorPrimaryCareFacility(IndexingMethod.slidingWindow(50, props),5);
