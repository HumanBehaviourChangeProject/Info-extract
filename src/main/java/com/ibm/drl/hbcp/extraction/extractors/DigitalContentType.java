...
/**
 * Extract references to digital content mode of delivery.
 *
 * @author charlesj
 *
 */
public class DigitalContentType extends OrOfKeywordsExtractor<ArmifiedAttributeValuePair> implements IndexBasedAVPExtractor {

    private static final String ATTRIB_NAME = "Digital content type";
    ...
    public DigitalContentType(IndexingMethod indexingMethod, int numberOfTopPassages) throws ParseException {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        DigitalContentType hp = new DigitalContentType(IndexingMethod.slidingWindow(50, props),5);
